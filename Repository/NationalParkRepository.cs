...
namespace dotnetCoreAPI.Repository
{
  public class NationalParkRepository : INationalParkRepository
  {
    ...
    {
      _db.NationalParks.Add(nationalPark); //.Add is a default you get on the entity framework, we have NationalParks because it was added in ApplicationDbContext.cs
      return Save();
    }
